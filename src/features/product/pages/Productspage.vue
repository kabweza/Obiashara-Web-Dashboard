    ...
    <div class="products-page">
        <div class="page-header">
            <div>
                ...
                <p class="page-sub">{{ active.length }} {{ t('products') }} · {{ lowStock.length }} {{ t('low_stock') }}
                </p>
            </div>
        ...
        <!-- Tabs -->
        <div class="tabs">
            <button class="tab" :class="{ active: tab === 'active' }" @click="tab = 'active'">{{ t('active') }} ({{
                active.length }})</button>
            <button class="tab" :class="{ active: tab === 'low' }" @click="tab = 'low'">{{ t('low_stock') }} ({{
                lowStock.length }})</button>
            <button class="tab" :class="{ active: tab === 'deleted' }" @click="tab = 'deleted'">{{ t('deleted')
                }}</button>
        </div>
        ...
        <div v-if="displayed.length === 0" class="empty-state">
            ...
            <button v-if="tab === 'active'" class="btn-add" @click="showAdd = true">{{ t('add_first_product')
                }}</button>
        </div>
        ...
        <div v-else class="products-grid">
            <div v-for="product in displayed" :key="product.id" class="product-card">
                ...
                <div class="product-image"
                    :class="{ 'out-of-stock': product.quantity === 0 && product.type === 'Product' }">
                    ...
                    <div v-if="product.type === 'Product' && product.quantity <= 5" class="stock-badge"
                        :class="product.quantity === 0 ? 'out' : 'low'">
                ...
                <div class="product-body">
                    ...
                    <div v-if="product.type === 'Product'" class="qty-row">
                        ...
                        <span class="qty-val"
                            :class="{ 'qty-low': product.quantity <= 5, 'qty-out': product.quantity === 0 }">{{
        ...
        <Teleport to="body">
            ...
            <ConfirmModal v-if="deleteTarget" :title="t('delete_product')" :message="t('delete_product_confirm')"
